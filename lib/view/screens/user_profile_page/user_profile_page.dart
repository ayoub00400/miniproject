  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return Scaffold(
        ...
        body: RefreshIndicator(
            onRefresh: () async {
              var newState = ref.refresh(userFutureProvider.call(userId));
            ...
            child: SafeArea(
                child: ref.watch(userFutureProvider(userId)).when(
              data: (data) {
                if (ref.watch(userFutureProvider(userId)).isRefreshing) {
                  return const Center(
